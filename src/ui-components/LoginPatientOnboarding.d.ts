...
export declare type LoginPatientOnboardingOverridesProps = {
    LoginPatientOnboarding?: PrimitiveOverrideProps<ViewProps>;
...
export default function LoginPatientOnboarding(props: LoginPatientOnboardingProps): React.ReactElement;
