...
import bgImage from "../images/banner3.png";
import "./Button.css";

export default function LoginPatientOnboarding03(props) {
  ...
  return (
    ...
    <Flex
      ...
      >
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="User Information and Consent"
        ></Heading>
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children="Share your details securely and 
            consent with confidence. Safeguarding Your Data with Stringent Security Measures:"
          ></Text>
        </Flex>
