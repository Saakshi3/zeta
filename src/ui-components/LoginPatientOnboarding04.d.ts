...
export declare type LoginPatientOnboardingOverridesProps = {
    LoginPatientOnboarding04?: PrimitiveOverrideProps<ViewProps>;
...
export default function LoginPatientOnboarding04(props: LoginPatientOnboardingProps): React.ReactElement;
