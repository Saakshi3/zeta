...
import bgImage from "../images/banner4.png";
import "./Button.css";

export default function LoginPatientOnboarding04(props) {
  ...
  return (
    ...
    <Flex
      ...
      >
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="Completion and Compliance"
        ></Heading>
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children="Ensuring the best consent management and privacy protection. 
            You're all set! Explore the app with confidence in our top-notch procedures."
          ></Text>
        </Flex>
        ...
        <Button variant="contained" color="#043495"> next</Button>
       
       </Stack> */}
        <Button variant="contained" bgcolor="#043495"
            width="unset"
            height="40px"
            shrink="0"
            alignSelf="stretch"
